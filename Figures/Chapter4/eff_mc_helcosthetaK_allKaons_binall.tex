...
\draw [anchor= east] (4.66,3.39311) node[scale=0.78483, rotate=0]{$\cos\thetaK$};
...
\draw [anchor=base] (0.772,3.4895) node[scale=0.52322, rotate=0]{-1};
\draw [anchor=base] (1.744,3.4895) node[scale=0.52322, rotate=0]{-0.5};
\draw [anchor=base] (2.716,3.4895) node[scale=0.52322, rotate=0]{0};
\draw [anchor=base] (3.688,3.4895) node[scale=0.52322, rotate=0]{0.5};
\draw [anchor=base] (4.66,3.4895) node[scale=0.52322, rotate=0]{1};
...
\draw [anchor= east] (0.3112,6.06181) node[scale=0.78483, rotate=90]{$\int d\thetamu \; d\phihel \;\; \epsilon(\Omega)$};

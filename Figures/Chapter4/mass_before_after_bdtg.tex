...
\draw [anchor= east] (9.5,0.317272) node[scale=1.00614, rotate=0]{$J/\psi K\pi \text{invariant mass} \mevcc$};
...
\draw [anchor= east] (0.3056,5.96141) node[scale=1.00614, rotate=90]{$\text{Candidates} / 10.0 \mevcc$};

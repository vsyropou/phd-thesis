...
\draw [anchor= east] (9.66,3.39311) node[scale=0.78483, rotate=0]{$\cos\thetamu$};
...
\draw [anchor=base] (5.772,3.4895) node[scale=0.52322, rotate=0]{-1};
\draw [anchor=base] (6.744,3.4895) node[scale=0.52322, rotate=0]{-0.5};
\draw [anchor=base] (7.716,3.4895) node[scale=0.52322, rotate=0]{0};
\draw [anchor=base] (8.688,3.4895) node[scale=0.52322, rotate=0]{0.5};
\draw [anchor=base] (9.66,3.4895) node[scale=0.52322, rotate=0]{1};
...
\draw [anchor= east] (5.3112,6.06181) node[scale=0.78483, rotate=90]{$\int d\thetaK \; d\phihel \;\; \epsilon(\Omega)$};

...
\def\cosTmu  {\ensuremath{\cos(\theta_{\mu})}\xspace} %Simon
...
\newcommand{\pdfs}{\ensuremath{p.d.f.s}\xspace}
...
\newcommand{\ReAmp}[4][1=A, 2=A]{\Re({#1}_{#3}^* {#2}_{#4})}
\newcommand{\ImAmp}[4][1=A, 2=A]{\Im({#1}_{#3}^* {#2}_{#4})} 
...
%    waves
\newcommand{\swave}{\ensuremath{S-wave}\xspace}
\newcommand{\pwave}{\ensuremath{P-wave}\xspace}
\newcommand{\dwave}{\ensuremath{D-wave}\xspace}
\newcommand{\hwave}{\ensuremath{H-wave}\xspace}
\newcommand{\fwave}{\ensuremath{F-wave}\xspace}

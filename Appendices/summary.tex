...
Despite its sucess, there are certain established phenomena and observations that Standard
...
see \figref{app_interference}. This imples that according to quantum mechanics the two decay
...
threashold lower. The results are summarised in \figref{app_eff_comp}, where the efficiency
...
plotting the fitted model on top of the data, see \figref{app_angular_plot_thetas}. The data in the latter figure consist

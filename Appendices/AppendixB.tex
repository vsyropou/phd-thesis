...
of \equref{cdf_def}, name it $c_i$, to each bin $x_i$. In that case, from an implementation point
...
continues is usign the well known techinique of {\it linear interpolation}, shown in \figref{linear_interpolation},

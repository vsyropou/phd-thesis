...
-- Finalise appendix (only extrapolations left), and spelcheck.

-- try to be consistent between event (the whole event), candidate (it passed your cuts), particle (the concept),
   decay (the fit says it's a Bs->J/psiK*).
-- Bibliography: prior to 2008, hep-ex was mandatory as part of the identifier. Clicking on ref. 71
    I get to https://arxiv.org/abs/0205021 instead of https://arxiv.org/abs/hep-ex/0205021.



From Patrick's e-mail:
Some comments you may not decipher well

 - In eq. 3.2 f_Lambda is special as it's not about a quark. You need to re-write the text afterwards.

 - P.40-45: I fail to understand why you treat J/psippi and J/psipK differently.

 - p.43: Hypathia has this shape because it catches an infinite sum of gaussians of different width. That's the main effect.

 - Section 3.2: would be good to have the true distributions of the angles.

 - P.78, ref [71]: Is the treatment of S-wave the same? Are we comparing pears and apples?

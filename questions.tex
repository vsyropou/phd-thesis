...
-- jpsi in \B2Jpsiphi and \jpsi is not the same.
-- Make Acp symbols in plots consistent with the text.
-- Remove appendix with datasets and striping (do not forget to remove references to it frmn the main text)
-- Add Figure from to jeroens figures and other.
-- Check captons again in Introduction chpater.

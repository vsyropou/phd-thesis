...
-- Spike in costhtamu distribution in the acceptance section from simulation sample.

To do for second draft.
-- spell check
-- justify the double minima in the likelihood scans delta->-delta but deltaperp -> pi-deltaperp (It is intreasting to point out that the \BsJpsiKst differential decay rate of as expressed by the in \equref{})

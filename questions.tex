...
-- hyphenation
-- Layout
  -- Save lines by rewritting (if needed, or it the text changes)
  -- position of plots and tables
  -- position of formulas
-- Same bibliography layout for techreports.
-- cover (increase resolution)
-- Hunt dead refs ??
-- ISBN

...
-- Fix your bibtex file (follow gerhards and patricks comments )
-- event display (send to ben blah and boleck, fix colors of the pv sv blobs)

Patrick's corrections:
-- Chap4:
 - Do I understand right you sWeight also before MVA tuning? Why don't you show this fit? (I do not sWeight before MVA. I just optimise for the best bdt cut using the sWeights.)
 - Fig 4.10: I don't see the qualitative difference between A and B (see KS test)
 - P.94: how is B(Bs->J/psiphi) measured? Is it uncorrelated with J/psiK*? (Do not uncerstand what patrick means)
-- Chapt5:
 - info from branching ratio: poorly written.?? (what does he mean. from patricks digital file )

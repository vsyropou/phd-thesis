...
Before printing:
-- Hunt dead refs ??
-- position plots and tables nicely with text
...
-- spell check
-- upercase in penguin plots (fix small Kstar symbol)
-- y titles in horizontal reweighting
-- varphi in 2d acc plots. and theta symbol tilted

-- Additional feynman diagrams in chapter 5

...
-- Residuals in MatchVeloMuon: Residulas versus Momentum (or eta).
-- Too long trigger chapter title
-- \kw{IsMuon} --> \isMuon
-- \velo tracks --> \veloTracks and same for veloTT
-- nDof universal notation

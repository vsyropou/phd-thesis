...
Patrick corrections:
 Chap 1 and 2 
-- Us UK spelling
-- have you tried \section[bla $\phi_s$]{\boldmath bla $\phi_s$} ?
-- you mix upright and slanted greek. Try to be consistent. The LHCb template does that in one go.
-- I don't think you need to explain the P->VV business in Sec.1 Leave it for J/psiK*.
      The reader does not have enough info in Sec. 1 to understand the details.
--\CP violation symbol
-- upper and lower case quarks
-- where is phis in figure 1.6
-- jpsi with capital J
-- CP eigenstates in at the end of section 1.3
-- 45 percent of the b quarks
-- calo contributes to global PID
-- not a good jpsikst event display ??, Nothing here??
-- Inverted loginc int he begining of chapter 3

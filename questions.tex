...
Todo to send to printer (in order):
-- Layout (one last final check)
-- Spell check:  Use US eng spelling

-- event display (send to ben blah and boleck, fix colors of the pv sv blobs)

-- Various
 - Send invitations (nikhef kai filoi)
 - Submit 5 copies to the pedel by 29 August.
 - Send liscence aggreement to tht vu library six weeks before the defence
 - Digital upload of thesis six weeks before (done)
 - Write elevator pich 1500 letters and translate it in dutch and then upload it to the (https://www.vu.nl/nl/nieuws-agenda/pers/formulier-promoveren/index.aspx)
 - Arrange reception
 - Arrange party
 - Pare lefta (mail barbara)
 - Get full list of instrutions guidelines send all the shit I hav eto do (mailled barbara vu)
 - Mail nikhef library what do I have to do (mallied nikhef library)

...
-- position plots and tables nicele with text.(do theis for the 3rd draft.)
-- also text around equations
...
-- b-bar oscilations symbols make them consitent.
-- mumu symbon in Bs to mumu and sigmapmumu
-- Make sure systematics table is up to date (copy from paper and check your systematics)

For 3rd draft:
-- Finish Patrick's corrections
-- Finish Gerahrd's corrections
-- finalise BsJpsiKst in LHCB section.
-- update penguin plots
-- Write introduction to introduction.
-- write conclusion and prospects in the penguin chapter.
-- try to be consistent between event (the whole event), candidate (it passed your cuts), particle (the concept), decay (the fit says it's a Bs->J/psiK*).
...
-- event display make the display and write comments. Make two displays perhaps....

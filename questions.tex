...
To Do (general).
-- Write introduction to introduction
...
-- justify the doub eminima in the likelihood scans

From patrick
P.11: I am surprised by the wide tails of the mass. Is that from MC? Do you apply a cut on the mass error? If not, why?
p.14: I am probably stupid. I don't see why pions fall out of the acceptance due to them being light. Are you sure
      it's a geometry effect and not due to the momentum cut in the tracking?
p.32: how is the stat error in 2.42 computed? Is that's just the J/psiK* yield? If so I don't see how that can be smaller than
      those in 2.40 and 2.41. P.11: I am surprised by the wide tails of the mass. Is that from MC? Do you apply a cut on the mass error? If not, why?
p.14: I am probably stupid. I don't see why pions fall out of the acceptance due to them being light. Are you sure it's a
      geometry effect and not due to the momentum cut in the tracking? Fig. 2,5 does not say how the efficiency is defined.
      As a general rule: whenever you give an efficiency make sure the numerator *and* the denominator are well defined.

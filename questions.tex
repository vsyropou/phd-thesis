...
-- CSP is not consistend
-- CP is not consistent use \CP
-- error --> uncertainty
-- hear after wtf??
-- above-mentioned ??? above mention gamw tin panagia.
-- space before \cite{} or not???
-- error or uncertainty
-- make dof and DOF consistent and nDof etc...

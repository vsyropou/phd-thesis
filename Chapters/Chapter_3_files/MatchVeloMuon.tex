...
\begin{figure}[!h]
 \centering
 \includegraphics[trim=0.4cm 0.1cm 0.5cm 0.3cm, clip=true,scale=0.4]{mvm/MvM/vim_efficiency_p.pdf}
 \includegraphics[trim=0.4cm 0.1cm 0.5cm 0.3cm, clip=true,scale=0.4]{mvm/MvM/vim_efficiency_pt.pdf}\\
 \includegraphics[trim=0.4cm 0.1cm 0.5cm 0.3cm, clip=true,scale=0.4]{mvm/MvTTM/vim_efficiency_p.pdf}
 \includegraphics[trim=0.4cm 0.1cm 0.5cm 0.3cm, clip=true,scale=0.4]{mvm/MvTTM/vim_efficiency_pt.pdf}

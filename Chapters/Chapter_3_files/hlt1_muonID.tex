...
which, combined with the novel online detector alignment and calibration endeavour \cite{Aaij:2016rxn}, see also \figref{det_run_two_trigger},
...
\cite{LHCb-PUB-2011-017}, to select these tracks with higher probabilyt of being muons. Subsequently, 

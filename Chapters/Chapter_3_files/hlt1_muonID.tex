...
The role of the trigger system and the decitions that it provides is presented in \secref{det_trigger},
...
is analysed further. The sequence is shown  in \figref{hlt1_algo_seq}. A brief summary of the

...
with the same cut values as in the \BsJpsiKst channel. The ratio of observed number of events is represented by the
first fraction in \equref{norm_jpsiPhi}, whereas the ratio of total efficiency between the two channels is denoted
by the second. The last fraction is corrected for known differences in efficiency between data and simulated data.
...
The final result for $\BRof{\BsJpsiKst}_d$ is:

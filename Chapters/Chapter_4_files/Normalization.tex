...
It requires as input the observed number of \BsJpsiKst and \BsJpsiPhi decays. The first one is taken from \equref{signal_yields} as for
...
All the above information is used to determine $\BRof{\BsJpsiKst}_\phi$ shown in \equref{Br_JpsiPhi}, where the uncertainties
...
The final result for $\BRof{\BsJpsiKst}_d$ is shown in \equref{Br_JpsiKst}
...
Both estimates of \equref{Br_JpsiPhi} and \equref{Br_JpsiKst} are compatible within uncorrelated systematic uncertainties. A weighted average of these two
...
expected number of decays estimated with the mass fit in \secref{Event_Selection}. In addition the efficiency ratios cannot be treated separately

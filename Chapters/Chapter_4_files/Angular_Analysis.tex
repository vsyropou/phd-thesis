...
in \Kstarz rest frame, which is releated to $\thetaK$ in \figref{helAngles} as: $\thetapi = \thetaK + \pi$.
...
Following parametrization of \equref{eff_func} one just needs to obtain a set of $c^i_{jk}$. Now, there are infinite efficiency moments

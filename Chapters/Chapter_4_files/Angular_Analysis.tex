...
\tabref{pars_convergence}. The central values of the parameters of interest does not change a lot impling that the overall effect of the acceptance
corrections is small. \figref{angAggCorrections} show (in arbitrary units) the shape of the acceptance beforea nd after corrections.
...
The last makes, in hindsight, the acceptance correction procedure (with the current number of observed evetns) not necessary.
...
\begin{figure}[h]
  ...
  \caption{Angular acceptance shape from simulated data before(black points) and after(red points) acceptance corrections.
           ...
           in the acceptance shape only. The plots are made in the same way as in \figref{angAcc_all}.}

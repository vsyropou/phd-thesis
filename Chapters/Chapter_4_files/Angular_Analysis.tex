...
Coming now to the concept of the extended likelihood. In \equref{likelihood} the number of candidates is fixed.
However it is possible to extend the last equation such that the expected number of candidates shows up as a parameter in the likelihood
...
probability to observe $n$ events when expecting $\expEvnts$ candidates. The expected number of candidates $\expEvnts$ depends on the

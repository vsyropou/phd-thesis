...
Her, the steps to arrive at an expression for the angular decay rate for \BsJpsiKst decays. In \equref{ang_terms}
...
\begin{figure}[h]
  ...
  \begin{subfigure}{0.49\textwidth}
    ...
    \scalebox{1.3}{\input{Figures/Chapter4/eff_mc_helcosthetaK_allKaons_binall}}
    \caption{}
    \label{angAcc_ctk}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.49\textwidth}
    ...
    \scalebox{1.3}{\input{Figures/Chapter4/eff_mc_helcosthetaL_allKaons_binall}}
    \caption{}
    \label{angAcc_ctl}
  \end{subfigure}
  ...
  \begin{subfigure}{0.49\textwidth}
    ...
    \scalebox{1.3}{\input{Figures/Chapter4/eff_mc_helphi_allKaons_binall}}
    \caption{}
    \label{angAcc_phi}
  \end{subfigure}
...
\begin{figure}[h]
  ...
  \begin{subfigure}{0.49\textwidth}
    ...
    \scalebox{1.3}{\input{Figures/Chapter4/eff_mc_helcosthetaK_allKaons_binall_rew}}
    \caption{}
    \label{angAccCor_ctk}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.49\textwidth}
    ...
    \scalebox{1.3}{\input{Figures/Chapter4/eff_mc_helcosthetaL_allKaons_binall_rew}}
    \caption{}
  ...
  \begin{subfigure}{0.49\textwidth}
    ...
    \scalebox{1.3}{\input{Figures/Chapter4/eff_mc_helphi_allKaons_binall_rew}}
    \caption{}

...
the angular acceptance as described in \secref{Accceptance} is calculated seperatelly for the \BsJpsiKst and \BsbarJpsiKst samples.
...
Ina ddition the \CSP factors of \secref{Kpi_Invariant_mass} need to be calculated and inserted seperatelly for each component \pdf resulting in

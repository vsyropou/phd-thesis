...
angles, denoted by $\Omega$, plus the \mkpi are required. As shown in \figref{helAngles}, the three \emph{helicity angles} angles
...
The subscripts T,L label the transverse and longitudinal components of the pion momentum, $\ptot_{\pi}$. The \CM
superscript indicates quantities evaluated in the \Kstarz rest frame. The symbol $E$ stands for the energy of
the pions. The Lorentz boost factor and the relativistic speed are labeled by $\gamma$ and $\beta$ respectively.
The angle $\thetapi$ is the angle of the pion momentum in \Kstarz rest frame and it is related to $\thetaK$
as: $\thetapi = \thetaK + \pi$. Now, the origin of the above mentioned asymmetry is understood better in the
limit of a mass less pion, in which case \equref{pi_angle} reduces to:
...
\noindent Note that for a mass-less particle the energy is equal to its total momentum and also that $\beta \simeq 1$
...
why the shape of the $\cos\thetaK$ distribution becomes asymmetric when excluding low momenta pions. This effect is more
...
Following the above parametrization one just needs to obtain a set of $c^i_{jk}$. Now, there are infinite efficiency moments
...
the $\Acp{k}$ parameters of interest introduced in \secref{cp_assymetries_and_total_decay_rate}.

...
\noindent given \equref{eff_func_constr} and also $\legendre{0}{0}=1$,  $\spharm{0}{0} = \frac{1}{2\sqrt{\pi}}$ \equref{eff_func_rewriten} can be easily solved for $\moment{0}{0}{0}$
...
\noindent \equref{eff_func_constr} is pluged in to \equref{eff_func_rewriten} resulting in \equref{}

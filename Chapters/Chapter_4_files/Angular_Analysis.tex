...
current paragraph. Both of those effects need to be estimated so that the experimentally measured assymetry,
$\Acp{\rm raw}$ is corrected for as shown in \equref{acp_corrected}. The last asymmetry defined in \equref{acp_mes}.
...
oscillations~\cite{LHCb-PAPER-2013-018}. The factor $\kappa$, is shown in \equref{kappa}.
...
the polariation dependant CP assymetries, \Acp{k}, as free parameters in the angular fit and how this becomes

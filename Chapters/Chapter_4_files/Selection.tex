...
For the signal-like samples, \BsJpsiKst Monte-Carlo simulated data (hear after simulated data)
...
essentially forces the sum of weights to be the same as the number of events.

...
\noindent As for the background representative sample, real data candidates are used. These candidates are taken from a control
...
when the distributions involved are smooth.
...
\noindent Therefore, specific simulated events with negative weights
...
The role of the amplitude polarization becomes more clear in \secref{Angular_Analysis}.
The final non-combinatorial background yields estimation after the above mentioned steps is shown in \tabref{peaking_bkg_yields}

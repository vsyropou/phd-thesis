...
Those backgrounds are the result of misidentified a final state particle, for example a pion can be confused for a kaon
by the event building algorithms.  

...
Prior to addressing the various selecton steps involved in detail, it is usefull to introduce the 
\sPlot techinique, which is used to reduce the combiantorial background further after the first 
...
of \equref{eqn:fom} essentialy expresses the signal fraction. For a range of BDT values the \sPlot technique

...
of the other non-combinatorial backgrounds, see \figref{mass_plot}, and as a result the \sPlot technique is still
effective.
...
of crucial importance. These two peaks are sufficiently close, see \figref{mass_plot}; Bad modeling of the tails implies

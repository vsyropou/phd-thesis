...
whereas background candidates near -1, see \figref{BTDG_performance}. In the current analysis the calsifyer variable is a
{\it Boosted Decision Tree}, BDT in short, which is a class of machine learning algoritm algorithm. Further information

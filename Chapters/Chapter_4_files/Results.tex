...
\tabref{bestFitResult} summarizes the parameters
of interest best fit values whereas \figref{angular_plot} shows the a plot of the fitted \pdf to the \BsJpsiKst data. The correlation matrix
...
by adding a term\footnote{with the appropriate $\frac{1}{2\sqrt{\pi}}$ normalization} to \equref{eff_func_new} and allowing it to

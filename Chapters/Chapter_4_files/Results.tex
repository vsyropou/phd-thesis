...
The likelihood function is profiled versus the parameters of interest in \secref{nllscans} to gain confidence on the validity
of the minimum. Finally a toy study is performed in \secref{Toy_Experiments_Study} to validate the fitting procedure against
...
The correlation matrix can be found in \tabref{correlation_matrix}.
...
\centering
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{1.15}{\input{Figures/Chapter4/angPlot_helcosthetaK}}
    \caption{}
    \label{angPlot_ctk}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{1.15}{\input{Figures/Chapter4/angPlot_helcosthetaL}}
    \caption{}
    \label{angPlot_ctl}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{1.15}{\input{Figures/Chapter4/angPlot_helphi}}
    \caption{}
    \label{angPlot_phi}
  \end{subfigure}
  \caption{Fitted angular \pdf projections on top of the \BsJpsiKst background subtructed data.
...
is used to constrain within the acceptance within $5$ standard deviations from their nominal value of \tabref{eff_moms_table}.
...
in the parameters of interest between the best fit of \tabref{bestFitResult} and the fit with the floating acceptance
...
Those estimates are summarized in \tabref{peaking_bkg_yields}, where one can see that they come with a statistical uncertainty as well.
...
interference terms of the angular \pdf, see \secref{Kpi_Invariant_mass}. The choice of those models has a small but measurable impact on the parameters of interest and it was made
...
\begin{figure}[!t]
  ...
  \caption{Profile likelihood scans of \swave related parameters of interest. The black line corresponds to the profile likelihood
         function projected over the corresponding parameter. The red curve is a parabola, with a symmetric Gaussian
         uncertainty. There are a two interesting features in those plots. First $\fS{1}$ minimum is very broad due to the
...
likelihood plots of the parameters of interest relevant to those data categories. This is also the reason why asymmetric uncertainties
are used.
...
\caption{Profile likelihood scans of \swave related parameters of interest. The black line corresponds to the profile likelihood
         function projected over the corresponding parameter. The red curve is a parabola, with a symmetric Gaussian
         uncertainty. There are a two interesting features in those plots. First $\fS{4}$ minimum is very broad due to the

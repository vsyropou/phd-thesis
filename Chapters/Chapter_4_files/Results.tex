...
The results of this fit are presented in the current section. Systematic uncertainties are discussed in \secref{systemics}.
...
of the minimum. Finally a toy study is performed in \secref{Toy_Experiments_Study} to validate the fitting procedure
...
\figref{angular_plot} shows the projections of the fitted angular \pdf on the data.
...
%%     \scalebox{0.56}{\input{Figures/Chapter4/pW_wave_yields}}
%%     \caption{}
%%     \label{skase}
%%   \end{subfigure}%
%%   \hfill%
...
%%     \scalebox{0.56}{\input{Figures/Chapter4/sW_wave_yields}}
%%     \caption{}
%%     \label{opasd}
%%   \end{subfigure}
%%   \begin{subfigure}{0.5\textwidth}
%%     \tikzsetnextfilename{phasesoffset_}
%%     \scalebox{0.56}{\input{Figures/Chapter4/phasesoffset_}}
%%     \caption{}
%%     \label{opa}
%%   \end{subfigure}%
...
To account for the previous uncertainty  the estimates of all peaking background species (\BsJpsiKK, \BsJpsipipi, \BdJpsipipi, and \LbJpsipK)
...
between the previous fit and the nominal angular fit is taken as a systematic uncertainty for the particular peaking
...
\begin{tabular}{ccc}
  \hline
  & \\
  Source & $\BRof{\BsJpsiKst}_d$ & $\BRof{\BsJpsiKst}_\phi$ \\
  & \\
  \hline
...
propagated and taken as systematic uncertainties for this analysis. They are added in quadrature to
...
of the function by expanding it as a Taylor series around the minimum. Notet that the constant term of the
...
\begin{figure}[!t]
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_ACP0}}
    \caption{}
    \label{nll_ACP0}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_ACPperp}}
    \caption{}
    \label{nll_ACPperp}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_ACPpar}}
    \caption{}
    \label{nll_ACPpar}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_ACPS}}
    \caption{}
    \label{nll_ACPS}
  \end{subfigure}
...
\begin{figure}[!t]
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_f0}}
    \caption{}
    \label{nll_f0}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_fpar}}
    \caption{}
    \label{nll_fpar}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_AparPhase}}
    \caption{}
    \label{nll_AparPhase}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_AperpPhase}}
    \caption{}
...
used to build the likelihood. 

Second, \equref{likelihood_exp} serves as an alternative method of estimating the statistical uncertainty
of a parameter of interest given a profile likelihood plot. Specifically, $s$ number of standard deviations are defined from 
...
\begin{figure}[!t]
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_ASMag2_bin1}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_ASPhase_bin1}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_ASMag2_bin2}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_ASPhase_bin2}}
    \caption{}
...
\begin{figure}[!t]
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_ASMag2_bin3}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_ASPhase_bin3}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_ASMag2_bin4}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.56}{\input{Figures/Chapter4/nll_ASPhase_bin4}}
    \caption{}
...
usually attributed to the statistical uncertainty of one standard deviation, within the freqientist interpretation of 
prpbability. Basically the claim is that one standard deviation guaranties that the probability that the true value 
...
In a non-biasing fitting model the pull distribution of a certain parameter follows a Gaussian distribution of zero mean and width
...
and it is unknown. The value of $p^{\rm gen}$ on the other hand is known and for the purposes of the toy experiment 
is a suitable replacement of the $p^{\rm true}$.
...
can be deduced from the mean of the pull and uncertainty distributions as shown in \equref{bias_def}.

...
\begin{figure}[h]
  \centering
  \begin{subfigure}{0.5\textwidth}
    \tikzsetnextfilename{nll_A0Mag2}
    \scalebox{0.60}{\input{Figures/Chapter4/nll_A0Mag2}}
    \caption{}
    \label{skase}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    \tikzsetnextfilename{nll_AperpMag2}
    \scalebox{0.60}{\input{Figures/Chapter4/nll_AperpMag2}}
    \caption{}
    \label{opasd}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
...
\begin{figure}[h]
  \centering
  \begin{subfigure}{0.5\textwidth}
    \tikzsetnextfilename{nll_f_S_bin1}
    \scalebox{0.60}{\input{Figures/Chapter4/nll_f_S_bin2}}
    \caption{}
    \label{skase}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    \tikzsetnextfilename{nll_f_S_bin2}
    \scalebox{0.60}{\input{Figures/Chapter4/nll_f_S_bin2}}
    \caption{}
    \label{opasd}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
    \tikzsetnextfilename{nll_f_S_bin3} 
    \scalebox{0.60}{\input{Figures/Chapter4/nll_f_S_bin3}}
    \caption{}
    \label{opa}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    \tikzsetnextfilename{nll_f_S_bin4} 
    \scalebox{0.60}{\input{Figures/Chapter4/nll_f_S_bin3}}
    \caption{}
    \label{opa}
  \end{subfigure}
...
\begin{figure}[h]
  \centering
  \begin{subfigure}{0.5\textwidth}
    \tikzsetnextfilename{pull_A0Mag2}
    \scalebox{0.60}{\input{Figures/Chapter4/pull_A0Mag2}}
    \caption{}
    \label{skase}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    \tikzsetnextfilename{pull_AperpMag2}
    \scalebox{0.60}{\input{Figures/Chapter4/pull_AperpMag2}}
    \caption{}
    \label{opasd}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
...
\begin{figure}[h]
  \centering
  \begin{subfigure}{0.5\textwidth}
    \tikzsetnextfilename{pull_f_S_bin1}
    \scalebox{0.60}{\input{Figures/Chapter4/pull_f_S_bin1}}
    \caption{}
    \label{skase}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    \tikzsetnextfilename{pull_f_S_bin2}
    \scalebox{0.60}{\input{Figures/Chapter4/pull_f_S_bin1}}
    \caption{}
    \label{opasd}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
    \tikzsetnextfilename{pull_f_S_bin3} 
    \scalebox{0.60}{\input{Figures/Chapter4/pull_f_S_bin1}}
    \caption{}
    \label{opa}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    \tikzsetnextfilename{pull_f_S_bin4} 
    \scalebox{0.60}{\input{Figures/Chapter4/pull_f_S_bin1}}
    \caption{}
    \label{opa}
  \end{subfigure}

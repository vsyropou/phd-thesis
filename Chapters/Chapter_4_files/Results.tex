...
The likelihood function is profiled versus the paramters of intereset in \secref{nllscans} to gain confidence on the validity
of the minimum. Finally a toy study is performed in \secref{Toy_Experiments_Study} to validate the fiting procedure against
statisitcal factuations and asess poteniatl fit biasses
...
\figref{angular_plot} shows the projections of the fitted anglar \pdf overlyied on the data.
...
\begin{table}[!h]
  ...
  \begin{tabular}{c c c c c c }
    ...
    \hline
  \end{tabular}
  \caption{\small Systematic uncertainties for the \pwave parameters of interest. Total uncertainties as in \tabref{systematics_acp}.}
...
\begin{table}[!h]
  ...
  \begin{tabular}{c c c c c c }
    ...
    \hline
  \end{tabular}
  \caption{\small Systematic uncertainties for the \swave fractions. Total uncertainties as in \tabref{systematics_acp}.}
...
\begin{table}[!h]
  ...
  \begin{tabular}{c c c c c c }
    ...
    \hline
  \end{tabular}
  \caption{\small Systematic uncertainties for the \swave phases. Total uncertainties expressed as in \tabref{systematics_acp}.}
...
\begin{tabular}{ccc}
  ...
  \hline
\end{tabular}
\caption{Systematic uncertainties for the branching fraction measurements. Numbers in units of $10^{-2}$.}
...
However, in the impact of \dwave is known in \cite{bsjpsikst-paper}. The systematic uncertainty
...
\begin{figure}[!t]
  ...
  \end{subfigure}
\caption{Pull distributions of the \pwave paramteres of interest.}
\label{pull_pwave}
\end{figure}

...
%%     \scalebox{0.57}{\input{Figures/Chapter4/pW_wave_yields}}
%%     \caption{}
%%     \label{skase}
%%   \end{subfigure}%
%%   \hfill%
...
%%     \scalebox{0.57}{\input{Figures/Chapter4/sW_wave_yields}}
%%     \caption{}
%%     \label{opasd}
%%   \end{subfigure}
%%   \begin{subfigure}{0.5\textwidth}
%%     \tikzsetnextfilename{phasesoffset_}
%%     \scalebox{0.57}{\input{Figures/Chapter4/phasesoffset_}}
%%     \caption{}
%%     \label{opa}
%%   \end{subfigure}%
...
\begin{figure}[!t]
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/nll_ACPperp}}
    \caption{}
    \label{nll_ACPperp}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
...
\begin{figure}[!t]
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/nll_f0}}
    \caption{}
    \label{nll_f0}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/nll_fpar}}
    \caption{}
    \label{nll_fpar}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/nll_AparPhase}}
    \caption{}
    \label{nll_AparPhase}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/nll_AperpPhase}}
    \caption{}
...
\begin{figure}[!t]
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/nll_ASMag2_bin1}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/nll_ASPhase_bin1}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/nll_ASMag2_bin2}}
    \caption{}
    \label{nll_ASMag2_bin1}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/nll_ASPhase_bin2}}
    \caption{}
...
\begin{figure}[!t]
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/nll_ASMag2_bin3}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/nll_ASPhase_bin3}}
    \caption{}
    \label{nll_ASPhase_bin3}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/nll_ASMag2_bin4}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/nll_ASPhase_bin4}}
    \caption{}
...
\begin{figure}[!t]
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_ACP0}}
    \caption{}
    \label{pull_ACP0}
  \end{subfigure}%% %
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_ACPperp}}
    \caption{}
    \label{pull_ACPperp}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_ACPpar}}
    \caption{}
    \label{pull_ACPpar}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_ACPS}}
    \caption{}
    \label{pull_ACPS}
  \end{subfigure}
...
\begin{figure}[!t]
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_f0}}
    \caption{}
    \label{pull_f0}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_fpar}}
    \caption{}
    \label{pull_fpar}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_AparPhase}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_AperpPhase}}
    \caption{}
...
\begin{figure}[!t]
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_ASMag2_bin1}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_ASPhase_bin1}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_ASMag2_bin2}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_ASPhase_bin2}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_ASMag2_bin3}}
    \caption{}
    \label{pull_ASMag2_bin2}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_ASPhase_bin3}}
    \caption{}
...
\begin{figure}[!t]
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_ASMag2_bin4}}
    \caption{}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \scalebox{0.57}{\input{Figures/Chapter4/pull_ASPhase_bin4}}
    \caption{}

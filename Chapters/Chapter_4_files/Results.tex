...
is used to constrain the efficeincy moments around their nominal values of \tabref{eff_moms_table}.
...
In addition, another systematic to account for ascociating $\Bd$ candidates to the $\Bs$ peak is assigned. As mentioned in \secref{Event_Selection}
...
and \equref{extloglikelihood} denote the same thing). Since the above assumptions reagarding the parameters,

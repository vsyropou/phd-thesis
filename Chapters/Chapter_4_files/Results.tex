...
are presented in the current section and are summarised from \tabref{systematics_acp} to \tabref{syst_normalisation}.
The total undertainties in the above tables is the quadratic sum of all the individual systematic uncertainties and
...
\begin{tabular}{ccc}
  ...
  \hline
\end{tabular}
\caption{Systematic uncertainties for the branching fraction measurements. Numbers exressed in units of $10^{-2}$.}

...
\caption{Pofile likeliood scans of \swave releated parameters of interest. The black line corresponds to the profile likeliood
         ...
         which has an impact on the corresponding pull distribution of \secref{Toy_Experiments_Study}. Lastly the $\delta{4}$ profile likelihood
...
\begin{table}
  ...
  \begin{tabular}{c c c c c }
    ...
    \cline{2-5}
    parameters & fit & pull & fit & pull \\ %\multicolumn{2}{c}{fit/pull} & \multicolumn{2}{c}{fitted,computed} \\
    \cline{1-5}

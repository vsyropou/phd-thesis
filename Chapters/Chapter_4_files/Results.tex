...
by adding a term to \equref{eff_func_new} and allowing it to
float in the above-mentioned fit to the data. The differences in the parameters of interest between the best fit
of \tabref{bestFitResult} and the fit with the floating acceptance is taken as a systematic uncertainty.

...
called {\it tis-tos} method \cite{Aaij:1493820}. In the context of this method a given reconstructed object,
...
trigger lines for the three stages of the \lhcb trigger system are  shown in \figref{det_run_one_muon_line_eff}.

There are two more features of the \lhcb trigger system worth mentioning. First is the {\it deferred}

...
the track object. The various track types are shown in \figref{track_types}. The most common tracks used are {\it long}
...
momentum momentum resolution of the tracking system, shown in \figref{det_deltappvp}, is $\nicefrac{\Delta p}{p} \sim 0.5 \%$
...
implies that the \phis measurement discussed in \secref{measuring_phis}, is indeed possible to perform.

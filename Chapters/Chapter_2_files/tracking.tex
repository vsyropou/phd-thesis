...
like the \Bs meson. This particular measurement requires knowledge of the {\it flight distance}, which is the
...
us crucial for the momentum measurement. As a result (horizontal,vertical) resolution varies from $(4,10)\mm$ to

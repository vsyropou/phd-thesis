...
While flavor physics is introduced in \secref{Flavor_Physics}. All of the above experiments aim at detecting,
...
As mentioned in the previous paragraph, the \lhcb experiment is dedicated in studying flavor physics,
...
suggested by \figref{bb_roduction_angles}. The previous region of solid angle is also called {\it forward region}.
...
throughout \secref{det_tracking} to \secref{det_calo}. Emphasis is given to the sub-detectors that are relevant

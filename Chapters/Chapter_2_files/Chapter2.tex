...
compared to \BdJpsiKst whose invariant mass is very close to the one of the \BsJpsiKst, see \secref{mass_BDTG_selection}.
...
respectively. A reconstructed \BsJpsiKst decay candidate is shown in \figref{det_jpsikst_cand}.
...
\begin{figure}[t]
  ...
  \begin{subfigure}{\textwidth}
    % \raggedright
    \includegraphics[width=\textwidth, trim=7cm 0cm 6cm 0cm, clip=true]{Figures/Chapter2/top}
    % \caption{}
    \label{det_evt_display_top}
  \end{subfigure}
  \begin{subfigure}{\textwidth}
    % \raggedleft
    \includegraphics[width=\textwidth, trim=5cm 0cm 3cm 0cm, clip=true]{Figures/Chapter2/side}
    % \caption{}

...
The kaons and pions are indistinguishable in the absence of dedicated particle identification, {\it PID}, detectors. 
...
The two {\it Cherenkov} based PID sub-detectors in \lhcb, \richone and \richtwo, aimed at identifying low and 
high momentum tracks respectively. The way the \rich systems provide particle identification information is 
based on the velocity measurement implied by the angle of emission of a Cherenkov radiation. 
...
identifying electrons, photons and pions, as mentioned in \secref{det_calo}.
...
contained withing the calorimeter. Furthermore in the case of neutral particles, like photons or \piz,
...
point of view. Furthermore, the lead material that is inter-layered between the \ecal and \hcal active detector material,
...
\begin{figure}[t]
  ...
  \caption{Horizontal (top) and vertical (bottom) cross section of an \lhcb event.
           Straight lines indicate Long tracks; where kaons, pions, muons, protons and electrons

...
Cherenkov radiation. The nominal PID efficiencies are shown in \tabref{pid_efficiencies}.
...
compared to the \BdJpsiKst whose invariant mass is very close to the \BsJpsiKst candidates, see \secref{mass_BDTG_selection}.

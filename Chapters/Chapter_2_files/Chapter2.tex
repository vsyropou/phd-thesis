...
Lastly, information from the \ecal and \hcal is used by PID algorithms utilising information from
...
\noindent the optimized selection described in \secref{det_pid} most of the background
...
be seen in \figref{mass_BDTG_selection} and \figref{mass_plot}.

After a decade of research at the subatomic level, a large number of natural phenomena have been accounted
...
particles acquire mass. Standard Model fermions are illustrated in \tabref{quarksLeptons}.
...
\begin{figure}[h!]
  \centering
  {\sffamily \input{Figures/Chapter1/WeakInteractions.tex}}
...
For completeness it is mentioned that the weak interaction violates both the parity ($P$) and the charge ($C$) symmetries.
...
In both cases \equref{lagrangian} is not invariant under parity or charge transformations. What is interesting experimentally

...
This type is called CPV {\it in the decay} or {\it direct} and its corresponding asymmetry is shown in \equref{cpv_decay}.

\begin{equation}
% \Acp{\text{dir}} \propto \Gamma(\Bs \rightarrow f) - \Gamma(\Bsb \rightarrow \bar{f}),

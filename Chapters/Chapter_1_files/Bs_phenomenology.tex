...
Finally, it is useful at this stage to introduce the \Bs and \Bsb decay rate formulas, for which a
full derivation can be found in \cite{PDG,DeBruyn-thesis,jeroenThesis}.
...
\noindent Time is represented by the letter $t$ and $\lambda_f$ is a parameter commonly used to parameterize

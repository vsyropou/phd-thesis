...
The \Bs meson is an electrically neutral particle that consists of two quarks, specificaly (\bquarkbar\squark).
...
and decay. The current section as well as \secref{WeakPhase} will qualitatively address the way that
...
\begin{figure}[h]
  ...
  \begin{subfigure}{0.5\textwidth}
    \centering
    {\sffamily \input{Figures/Chapter1/box2}}
    \caption{}
    \label{bs_box_2}
  \end{subfigure}
...
Theoretical calculations~\cite{Lenz:2011ti} and experimental measurement~\cite{asl-paper}
measurements\footnote{Some tensions~\cite{asl-paper} between theory and experiment are stil to be resolved in the future.
The tensions are mainly due to the \dzero measurement~\cite{Abazov:2013uma}.} point to the ratio \qoverp being comaptible with one.
...
Another type of CP-Violation the so called {\it in the decay} or {\it direct} CP violation it is based on the

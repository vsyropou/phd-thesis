...
\begin{itemize}
  \item Write a short general introduction on what this thesis is about
  \item Focus on the new search for new physics
  \item Cite some textbooks for further reading on standard model, and on cp violation.
\end{itemize}
...
\label{lhcb_detector}
\input{Chapters/Chapter_1_files/lhcb_detector}

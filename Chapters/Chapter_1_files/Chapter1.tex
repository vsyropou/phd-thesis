...
An intrasting aspect of the weak interaction, emerges from this term, namelly the quark field mixing.
...
As it was mentioned in \secref{The_Standard_Model} quark and lepton fields aquire mass in the yuakawa
term of the Standard Model lagrangian. The masses are introduced after the so called {\it spontaneus symmetry
breaking}[ref] which is done by the
higgs mechanism[ref]\footnote{The higgs mechanism is a situation were the higgs potential in \equref{lagrangian}
is chosen such that its lowest value, the so called {\it vacum expectation value}, breaks the symmetry of the lagranian.}.
After that the quarck fields are expressed in the flavor

...
\equref{phis_theo}\cite{ckm-fitter-phis-pred}\footnote{updated with summer 2015 result from the CKM-fitter group.} 
...
Model prediction \phiS{SM,tree}, within the current experimental accuracy. However with the increasing accuracy at the \lhcb experiment the previous 

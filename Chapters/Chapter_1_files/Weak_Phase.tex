...
Under the assumption that for this final state only the leading order diagrams of \figref{bs_box}
...
\phiS{eff} value is consistent with the Standard Model prediction \phiS{SM,tree}, within the current experimental accuracy.
...
Furthermore, the \grpsuthree symmetry, introduced in \chapref{Penguins}, is invoked to involve similar decay channels as \BsJpsiPhi as well.
...
the penguin shift, $\Delta\phiS{SM,peng}$, using the channels \BsJpsiKst and \BsJpsiRho is also given in \chapref{Penguins}.

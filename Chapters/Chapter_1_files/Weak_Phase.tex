...
{\it decay time} of the \Bs (\Bsb) meson. Where decay time is the time interval between the production and decay of a particle.
...
decay amplitudes. Re-writing the imaginary part of \equref{lambdaf_ckm} taking into account \equref{ckm_angles_def},
one can obtain:
...
The combined \phis value from the \lhcb experiment \cite{phis-3fb-paper} is:
...
\begin{figure}[h]
  ...
  \caption{ Higher order-penguin diagram. This diagram is suppressed as explained in \secref{Penguins}. Figure from \cite{jeroenThesis}}

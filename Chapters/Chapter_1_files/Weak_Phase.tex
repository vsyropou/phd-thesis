...
shown in \figref{bs2jpsiphi} and \figref{bs_box} repsectivelly. Based on these diagrams the ratios $\qoverp$ and $\nicefrac{A_f}{\bar{A}_{f}}$
...
$\lambda_{f}$ of \equref{lambda_cpv} is can be computed, see \equref{phis_def}.

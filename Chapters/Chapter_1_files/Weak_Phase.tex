...
\noindent It can be seen that the asymmetry of \equref{cpv_interf} shows an oscillatory behaviour versus time, due
...
to \equref{cpv_interf} and \equref{cp_asym_lambda} CP asymmetry can still be observed in the interference between decay and
...
independent\footnote{some residual dependence is left, similar to the onedescribed in \secref{Kpi_Invariant_mass}. }

...
of the \mkk mass variable and thus much simpler. However an angular analysis (very similar to the one discribed in \secref{Diferential_Decay_Rate} )
...
wavefunction, used in \equref{phis_jpsiphi_def}, can be determined. In addition, as it was already implied \phis can be correctly probed only when the

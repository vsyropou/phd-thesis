...
final state $f$ and using the \BBbarSyst decay rate equations, the assymetry of \equref{cpv_interf_def}
can be expressed as:
...
\equref{bs_mass_eigen}. The definition of \Acp{\rm dir} in \equref{cp_asym_lambda} explicitly captures
...
one could chose the \Acp{\rm dir} definition of \equref{cpv_decay}. The full derivation of the
...
Firthermore, the \grpsuthree symmetry, introduced in \chapref{Penguins}, is invoked to involve similar decay channels as \BsJpsiPhi as well.

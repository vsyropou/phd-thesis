...
utilizes three real parameters, $\lambda,A,\rho$ and an imaginary one $i\eta$, as shown in \equref{CKMwolfenstein}.
...
in \equref{unitConstraints}, are relevant for this thesis since the CKM elements present in those relations govern the

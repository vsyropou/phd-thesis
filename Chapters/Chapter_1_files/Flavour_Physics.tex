...
\noindent These two relations, after dividing by $\Vcd\Vcb^*$, $\Vcs\Vcb^*$ respectivelly for \Bd and \Bs, are illustrated in \figref{unitTriangles}.
...
\noindent Note that the definitions of \equref{ckm_angles_def} are independant of

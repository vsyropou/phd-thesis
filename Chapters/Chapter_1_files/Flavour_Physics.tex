...
utilizes the three real parameters, $\lambda,A,\rho$ and the imaginary one $i\eta$, as shown in \equref{CKMwolfenstein}.
...
represented by triangles in the complex plane. There are six orthogonality relations, two of which, shown in \equref{unitConstraints}, are

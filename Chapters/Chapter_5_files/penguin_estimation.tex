...
Note that the information from those channels entering through the observables, \equref{bsjpsiphi_peng_acp_obs} and \equref{hobs_def}
...
The \BsJpsiKst channel is a flavor specific decay with the same topology as \BsJpsiPhi, see \figref{bs2jpsikst}.
The amplitude of \BsJpsiKst, is parameterized following the same concept as in the case of \BsJpsiPhi and is
...
is reported in \tabref{bestFitResult}, with the associated systematic quoted in \tabref{systematics_acp}.
...
$\DeltaPhisJpsiPhi{k}$ compared to \equref{delta_phis_jpsikst}. According to~\cite{DeBruyn-thesis} the last is attributed

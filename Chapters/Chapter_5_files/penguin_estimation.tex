...
First perfect $\grpsuthree_{\rm F}$ symmetry, shown in \equref{su3_apply}, is assumed between the \BsJpsiPhi and the
...
by treating the single hadronic ratio, based on the assumption of \equref{had_ratios_assuption},
...
in \secref{bsjpsirho_chanell} and \secref{bsjpsikst_chanell} respectivelly are used to define the
$\chi^2$ of \equref{chisq_form}.
...
$\chi^2$ fit with a gausian constrain around their Standard Model value, shown in \tabref{chi2_fit_constrains}.
...
using \equref{tandelta}, to the final estimate for the penguin phase shift on \phis. The results of the
$\chi^2$ fit are shown in \secref{penguin_results}.

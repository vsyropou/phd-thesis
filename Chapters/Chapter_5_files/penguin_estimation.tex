...
\begin{subequations}
  ...
  \begin{align}
    \DeltaPhisJpsiPhi{0}         & = +0.001^{+0.100}_{-0.033}\:,\\
    \DeltaPhisJpsiPhi{\parallel} & = +0.031^{+0.059}_{-0.052}\:,\\
    \DeltaPhisJpsiPhi{\perp}     & = -0.046^{+0.022}_{-0.028}\:.
  \end{align}
\end{subequations}
...
The topology of the \BsJpsiRho decay is shown in \figref{bs2jpsirho_diagram}. The amplitude structure is identical
...
\noindent where the ${}^{\prime\prime}|$ from here and on labels parameters related to the \BsJpsiRho decay.
Note again the absence of the subression factor $\epsilon$.

The \BsJpsiRho chanell provides access to both \Acp{\rm dir}, \Acp{\rm mix} since the final state $\jpsi\rho$ is
...
\begin{subequations}
  ...
  \begin{align}
    \DeltaPhisJpsiPhi{0}         & = -0.000^{+0.011}_{-0.014}\:,\\
    \DeltaPhisJpsiPhi{\parallel} & = +0.001^{+0.012}_{-0.017}\:,\\
    \DeltaPhisJpsiPhi{\perp}     & = +0.003^{+0.012}_{-0.016}\:.
  \end{align}
\end{subequations}

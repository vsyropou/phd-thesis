...
parameter, mentioned in \equref{lambda_cpv}. These two parameters are summarised as in the following equation:
...
The \BsJpsiKst amplitude is parameterized following the same concept as in the case of \BsJpsiPhi resulting in:

...
which is not precise enough given the uncertainty of $\phis^{\jpsi\Pphi}$. This is related to the suppression factor $\epsilon$, mentioned in
...
Whereas the $\Hobs{k}'$ observable is constructed from \BRof{\BsJpsiKst} reported in \equref{Br_total} and shown in
...
\noindent Second, the hadronic ratios necessary for building the $\Hobs{k}$ observable is assumed to be the same between

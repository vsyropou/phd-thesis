...
details of the fitting strategy to estimate the penguin paramters.
...
to the one described in \secref{penguin_chi2_fit}, hence details of the fitign strategy are postponed for later.
...
The amplitude structure is identical to that of the \BsJpsiKst mode resulting in \equref{bsjpsirho_amp}.
...
Specifically, as it can be seen in \equref{tandelta}, the algebreic structure of the

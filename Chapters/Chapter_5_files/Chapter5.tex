...
As explained in \secref{TheBsJpsiKstDecay} higher order effects become more relevant in the pursuit
...
parameters that quantify penguin topologies increases. From \secref{jpsiphi_amp_struct} to
\secref{penguin_more_chanells} the fundamentals of the necessary formalism are introduced.
Details of the penguin parameter estimation are explained in \secref{penguin_more_chanells}.

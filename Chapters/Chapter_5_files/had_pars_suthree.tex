...
in \equref{hobs_def}, does require the explicit calculation of ratios of hadronic factors. Thus on the one hand
...
As will be explained in \secref{penguin_more_chanells} introducing the previous the $\formFctr{k}$

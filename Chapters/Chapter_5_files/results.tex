...
\begin{figure}[t!]
  ...
  \caption{Confidence levels $\aPeng{0}$, $\thPeng{0}$. Measurements of \equref{chisq_form_with} are illustrated with
           colored bands, which correspond to one standard deviation. Figure is based on \cite{DeBruyn-thesis}
           and updated with the \BsJpsiKst polarization fractions and \Acp{dir} from \tabref{bestFitResult}.}
  \label{pengPlot_long}
\end{figure}
...
not fully satisfied. The best fit estimates of \equref{peng_a_theta_results} are subsequently translated,
using \equref{tandelta}, to the phase shifts $\DeltaPhisJpsiPhi{k}$ as:
...
effects entering through the assumption of \equref{su3_apply} cancel out \cite{Fleischer:1999zi}.
...
experimental measurement between the observables \equref{chisq_form_with}. Both issues are addressed in what follows.
...
In addition, the correlated fit result is compatible with the nominal fit of \secref{penguin_chi2_fit},

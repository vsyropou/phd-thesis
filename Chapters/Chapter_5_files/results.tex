The results of the \chisq fit described in \secref{penguin_more_chanells} are the following:
...
which suggests that the assumption \equref{had_ratios_assuption} is probably not true.
...
uncertainties due to both \grpsuthree breaking and the hadronic parameters \formFctr{k}. 

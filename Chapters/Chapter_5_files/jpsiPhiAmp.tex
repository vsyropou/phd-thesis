...
% \begin{figure}[h]
%   \centering
%   \scalebox{0.9}{\sffamily \input{Figures/Chapter5/exchange_penguin_annihilation_jsiphi}}
%   \caption{Higher order diagrams of \BsJpsiPhi. Left: Exchange. Right penguin annihilation topology.}
%   \label{bs2jpsiphi_add_topo}
% \end{figure}

...
Given these assumptions the \BsJpsiPhi amplitude is decomposed in \equref{bsjpsiphi_amp}, taking into account the relevat CKM elements involved in each topology.
...
in a bit more detail, in in \secref{had_pars_suthree}.
The subsctipt $k$ is identical to the one defined in \equref{amps_param} of \chapref{Data_Analysis} and denotes the \BsJpsiPhi

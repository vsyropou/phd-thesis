...
$\epsilon$ needs to be applied. This implies that the transformation $(\akPeng\to-\epsilon\akPeng)$ has to be performed.
...
Details of this fit are given in \secref{penguin_chi2_fit}.
...
\noindent with $y_s = \Delta\Gamma_s / 2\Gamma_s$. The parameter $\Gamma_s$ is the average decay width
of the $\BBbarSyst$ introduced in \secref{the_bbar_system}. The exact numbers for the \CP-even,

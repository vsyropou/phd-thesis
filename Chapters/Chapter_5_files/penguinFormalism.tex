...
can be related to the \CP asymmetries of \equref{cp_asym_lambda} as in the folowing equations:
...
As already mentioned in this chpater's introduction, the aim is to increase the precision on $\Delta{\phis}$

...
can be related to the \CP asymmetries of \equref{cp_asym_lambda} as shown in the folowing equation:
...
asymmetry, $\Acp{\rm dir}\left(\Bq\to (f)^k\right)$ = \Acp{k}, as quated in \secref{cp_assymetries_and_total_decay_rate} 

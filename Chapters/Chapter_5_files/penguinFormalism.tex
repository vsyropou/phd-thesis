...
Despite providing the second equation the $\Hobs{k}$ observable relies on external input, specifically the hadronic quantities $\formFctr{k}$.
...
as explained in \secref{had_pars_suthree}. For this reason the use of $\Hobs{k}$ is not always preferred.

...
\secref{cp_assymetries_and_total_decay_rate} respectively. Equations \ref{bsjpsiphi_peng_acp_obs} form a $2\times2$ system in
...
explained later in the current section.
...
as it provides providing the second equation necessary to solve for $(\akPeng,\thkPeng)$. Such channels
